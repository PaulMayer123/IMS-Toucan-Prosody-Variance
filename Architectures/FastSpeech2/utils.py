...
import Architectures.FastSpeech2.ConditionalLayerNorm
...
def initialize(model, init):
    ...
    for m in model.modules():
        if isinstance(m, (torch.nn.Embedding,
                          torch.nn.LayerNorm,
                          Architectures.FastSpeech2.ConditionalLayerNorm.ConditionalLayerNorm,
                          Architectures.FastSpeech2.ConditionalLayerNorm.SequentialWrappableConditionalLayerNorm
                          )):
            m.reset_parameters()
